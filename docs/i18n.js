...
const I18N = {
  en: {
    ...
    hero_sub: 'Keep your receipts, invoices and statements — even from services that make bulk export difficult. Habeas runs locally inside your authenticated browser session, with no stored credentials.',
    ...
    how_h2: 'How it works',
    how_lead: 'Habeas runs inside the browser session you already use. You log in yourself — Habeas reuses that live session without storing your password.',
    ...
    source_defs_lead: 'New services can be added without changing the Habeas runtime itself.',
    ...
    source_defs2_b: 'Anyone can add support for a new service by contributing a source definition. The catalog grows service by service.',
    recorder_h2: 'Add support for a new service',
    recorder_lead: 'If a service you need is not yet in the catalog, the session recorder can help you add it — no code required.',
    recorder_steps_h: 'How it works',
    recorder_step_1: 'Browse and authenticate normally on the site you want to add.',
    recorder_step_2: 'Habeas observes the session and infers a draft source definition.',
    recorder_step_3: 'Review and refine the definition until it fits your case.',
    recorder_step_4: 'Optionally contribute it back to the community catalog.',
    recorder_note: 'The inferred definition is a starting point, not a finished result. You stay in control throughout.',
  ...
  es: {
    ...
    hero_sub: 'Conserva tus tickets, facturas y extractos — incluso en servicios que no ofrecen exportación masiva. Habeas corre de forma local dentro de tu sesión autenticada del navegador, sin guardar credenciales.',
    ...
    how_lead: 'Habeas corre dentro de la sesión del navegador que ya usas. Tú haces el login — Habeas reutiliza esa sesión viva sin guardar tu contraseña.',
    ...
    source_defs_lead: 'Pueden añadirse nuevos servicios sin cambiar el runtime de Habeas.',
    ...
    source_defs2_b: 'Cualquiera puede añadir soporte para un nuevo servicio contribuyendo una definición de fuente. El catálogo crece servicio a servicio.',
    recorder_h2: 'Añadir soporte para un nuevo servicio',
    recorder_lead: 'Si un servicio que necesitas aún no está en el catálogo, el grabador de sesión puede ayudarte a añadirlo — sin código.',
    recorder_steps_h: 'Cómo funciona',
    recorder_step_1: 'Navega y autentícate normalmente en el sitio que quieres añadir.',
    recorder_step_2: 'Habeas observa la sesión e infiere un borrador de definición de fuente.',
    recorder_step_3: 'Revisa y refina la definición hasta que se ajuste a tu caso.',
    recorder_step_4: 'Si quieres, contribuye la definición al catálogo de la comunidad.',
    recorder_note: 'La definición inferida es un punto de partida, no un resultado acabado. Mantienes el control en todo momento.',
