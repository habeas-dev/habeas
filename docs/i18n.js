...
const I18N = {
  en: {
    ...
    hero_sub: 'Habeas is an open-source browser extension that exports your receipts, invoices and transactions from your authenticated browser session — no stored credentials, no server-side scraping.',
  ...
  es: {
    ...
    hero_sub: 'Habeas es una extensión de navegador de código abierto que exporta tus tickets, facturas y movimientos desde tu sesión autenticada del navegador — sin guardar credenciales ni hacer scraping desde un servidor.',
