...
const I18N = {
  ...
  es: {
    ...
    install_h2: 'Instalar',
    install_lead: 'Libre y de código abierto. Llegará a la Chrome Web Store y a Firefox Add-ons — mientras tanto, instala la última versión firmada.',
