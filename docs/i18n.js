...
const I18N = {
  en: {
    ...
    install_h2: 'Install',
    install_lead: 'Install from your browser’s store — Chrome, Edge or Firefox — or grab the raw build from GitHub Releases.',
    install_chrome_h: 'Chrome & Chromium',
    install_chrome_b: 'Chrome, Brave, Opera and other Chromium browsers.',
    install_chrome_cta: 'Add to Chrome',
    install_edge_h: 'Microsoft Edge',
    install_edge_b: 'Edge on Windows or macOS — from Edge Add-ons, with no cross-store warning.',
    install_edge_cta: 'Add to Edge',
    install_releases_h: 'Unpacked build',
    install_releases_b: 'The same package, straight from the repository — load it yourself, or read it before you do.',
    install_releases_cta: 'Get it on GitHub Releases',
    install_others_h: 'Install on other browsers',
    install_others_methods_h: 'Other browsers and ways to install',
    ...
    how3_b: 'Download original files or send them to a folder, cloud storage or app of your choice.',
    start_h2: 'Your first extraction, in four steps',
    start_lead: 'From install to saved documents — all inside your own browser session.',
    start1_h: '1. Install and pick a source',
    start1_b: 'Add Habeas, open it, and choose the service you want — a shop, a provider, your bank.',
    start2_h: '2. Log in as always',
    start2_b: 'Open the site and sign in yourself; MFA and OTP work as usual. Your password is never seen or stored.',
    start3_h: '3. Collect your documents',
    start3_b: 'Habeas lists your receipts, invoices or statements and fetches the original files — entirely inside your browser.',
    start4_h: '4. Choose where they go',
    start4_b: 'Save to a folder or your cloud (Drive, Dropbox, WebDAV, S3), or send to an app. Turn on automatic mode to sync new documents on each login.',
    start_note: 'Nothing leaves your browser until you choose a destination — and you can read every line of the code.',
    ...
    flow_step_sink: 'Sinks: Folder • Cloud • Apps • HTTP',
    ...
    recorder_lead: 'If a service you use is not yet in the catalogue, there are three ways to add it — pick the one that fits you.',
    ways1_h: 'Local only',
    ways1_b: 'Record the session in the extension and keep the source private — it never leaves your machine, and neither does your data. No code. You can still choose to share it later.',
    ways2_h: 'Assisted',
    ways2_b: 'Send a redacted recording (you review exactly what leaves your browser) to the Habeas team; they finish, verify and publish it — and credit you. No code.',
    ways3_h: 'Advanced (AI + proxy)',
    ways3_b: 'Technical contributors capture the traffic themselves and hand-author the source with any AI plus the repository, verify it offline, and open a pull request. Any service, any complexity.',
    recorder_note: 'The first path stays private; the other two grow the shared catalogue for everyone.',
    ...
    dest2_h: 'Cloud storage',
    dest2_b: 'Upload natively to Google Drive, Dropbox, or any WebDAV or S3-compatible storage — your own account, only the files Habeas creates.',
  ...
  es: {
    ...
    install_h2: 'Instalar',
    install_lead: 'Instálalo desde la tienda de tu navegador —Chrome, Edge o Firefox— o descarga la build directa desde GitHub Releases.',
    install_chrome_h: 'Chrome y Chromium',
    install_chrome_b: 'Chrome, Brave, Opera y otros navegadores Chromium.',
    install_chrome_cta: 'Añadir a Chrome',
    install_edge_h: 'Microsoft Edge',
    install_edge_b: 'Edge en Windows o macOS — desde Edge Add-ons, sin el aviso de otra tienda.',
    install_edge_cta: 'Añadir a Edge',
    install_releases_h: 'Build sin empaquetar',
    install_releases_b: 'El mismo paquete, directo del repositorio: cárgalo tú mismo, o léelo antes de hacerlo.',
    install_releases_cta: 'Descárgala en GitHub Releases',
    install_others_h: 'Instalar en otros navegadores',
    install_others_methods_h: 'Otros navegadores y formas de instalar',
    install_firefox_h: 'Firefox',
    ...
    how3_b: 'Descarga los ficheros originales o envíalos a una carpeta, la nube o app de tu elección.',
    start_h2: 'Tu primera extracción, en cuatro pasos',
    start_lead: 'De la instalación a tus documentos guardados — todo dentro de tu propia sesión del navegador.',
    start1_h: '1. Instala y elige una fuente',
    start1_b: 'Añade Habeas, ábrelo y elige el servicio que quieras — una tienda, un proveedor, tu banco.',
    start2_h: '2. Inicia sesión como siempre',
    start2_b: 'Abre el sitio y entra tú mismo; el MFA y el OTP funcionan igual. Tu contraseña no se ve ni se guarda.',
    start3_h: '3. Recolecta tus documentos',
    start3_b: 'Habeas lista tus tickets, facturas o extractos y descarga los ficheros originales — todo dentro de tu navegador.',
    start4_h: '4. Elige a dónde van',
    start4_b: 'Guárdalos en una carpeta o en tu nube (Drive, Dropbox, WebDAV, S3), o envíalos a una app. Activa el modo automático para sincronizar los nuevos documentos en cada inicio de sesión.',
    start_note: 'Nada sale de tu navegador hasta que eliges un destino — y puedes leer todo el código.',
    ...
    flow_step_sink: 'Destinos: Carpeta • Nube • Apps • HTTP',
    ...
    recorder_lead: 'Si un servicio que usas aún no está en el catálogo, hay tres maneras de añadirlo — elige la que encaje contigo.',
    ways1_h: 'Solo local',
    ways1_b: 'Graba la sesión en la extensión y guarda la fuente en privado — no sale de tu equipo, y tus datos tampoco. Sin código. Y si quieres, puedes compartirla más adelante.',
    ways2_h: 'Asistida',
    ways2_b: 'Envía una grabación redactada (revisas exactamente qué sale de tu navegador) al equipo de Habeas; ellos la terminan, verifican y publican — y te acreditan. Sin código.',
    ways3_h: 'Avanzada (IA + proxy)',
    ways3_b: 'Los contribuidores técnicos capturan el tráfico ellos mismos y redactan la fuente con cualquier IA y el repositorio, la verifican sin conexión y abren una pull request. Cualquier servicio, cualquier complejidad.',
    recorder_note: 'La primera vía queda privada; las otras dos amplían el catálogo compartido para todos.',
    ...
    dest2_h: 'Almacenamiento en la nube',
    dest2_b: 'Sube de forma nativa a Google Drive, Dropbox, o cualquier repositorio WebDAV o S3 (y compatibles) — tu propia cuenta, solo los ficheros que Habeas crea.',
