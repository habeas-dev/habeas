...
const I18N = {
  en: {
    ...
    ways1_h: 'Local only',
    ways1_b: 'Record the session in the extension and keep the source private — it never leaves your machine, and neither does your data. No code.',
    ways2_h: 'Assisted',
  ...
  es: {
    ...
    ways1_h: 'Solo local',
    ways1_b: 'Graba la sesión en la extensión y guarda la fuente en privado — no sale de tu equipo, y tus datos tampoco. Sin código.',
    ways2_h: 'Asistida',
